...
Route::get('/hobbie', [HobbieController::class, 'showHobbie'])->name('hobbie.showHobbie');
...
Route::get('/contacts', [ContactsController::class, 'showContacts'])->name('contacts.showContacts');
Route::get('/contacts/create', [ContactsController::class, 'createContacts']);

Route::get('/work', [WorkController::class, 'showWork'])->name('work.showWork');
...
Route::get('/news', [NewsController::class, 'showNews'])->name('news.showNews');
